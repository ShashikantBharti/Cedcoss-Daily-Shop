...
function Get_All_addresses() 
{
    ...
    $sql = "SELECT * FROM `billing_details` ORDER BY `id` DESC";
    $addresses = $conn -> query($sql) or die("All Billing Address Selection Query Failed !!!.");
}
            ...
            <div class="content-box">
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" class="<?php if (!isset($_REQUEST['id'])) { echo 'default-tab'; }  ?>">Billing Addresses</a></li>
                    </ul>
