...
{
    global $conn,$order_details;
    $select_all_order_details_sql = "SELECT * FROM `order_details` ORDER BY `id` DESC";
    $order_details = $conn -> query($select_all_order_details_sql) or die("All Order Details Selection Query Failed !!!.");
}
            ...
            <div class="content-box">
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" class="<?php if (!isset($_REQUEST['id'])) { echo 'default-tab'; }  ?>">Order Details</a></li>
                    </ul>
                    ...
                    <div class="tab-content default-tab" id="tab1">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" value="<?php echo $order_detail['id']; ?>"/></td>
                                    <td><?php echo $sr; ?></td>
