...
{
    global $conn,$orders;
    $select_all_orders_sql = "SELECT * FROM `orders` ORDER BY `id` DESC";
    $orders = $conn -> query($select_all_orders_sql) or die("All Users Selection Query Failed !!!.");
}
            ...
            <div class="content-box">
                ...
                <div class="content-box-header">
                    ...
                    <ul class="content-box-tabs">
                        <li><a href="#tab1" class="<?php if (!isset($_REQUEST['id'])) { echo 'default-tab'; }  ?>">Orders</a></li>
                    </ul>
                    <div class="clear"></div>
                </div>
                    ...
                    <div class="tab-content default-tab" id="tab1">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><input type="checkbox" value="<?php echo $order['id']; ?>"/></td>
                                    <td><?php echo $sr; ?></td>
